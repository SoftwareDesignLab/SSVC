...
### Load dataset
###
dataset = "Rawdata364partial364total"
...
def perform(X_description, y, model, classification, augment_synonyms=True, X_integrity=None, X_confidentiality=None):
    ...
    for train_idx, test_idx in kf.split(X_description):
        ...
        # joblib.dump(model, f"logreg_bow_synaug.joblib")
        # joblib.dump(v, "bow_vectorizer.pkl")
        # calculate metrics
...
def predict_description(cve_description, working_dir=os.path.dirname(__file__)):
    ...
    """
    model = joblib.load(os.path.join(working_dir, "models/logreg_bow_synaug.joblib"))
    vectorizer = joblib.load(os.path.join(working_dir, "models/bow_vectorizer.pkl"))
